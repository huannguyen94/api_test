...
//    Amqp::publish('trip.updated', '{"type":"trip.bks","payload":{"trip_id":[38507,38508]}}' , ['exchange' => 'trip_events', 'vhost' => 'havazerp']);
	Amqp::publish('1-routing-trip-erp', '{"merchant_id":"1","type":"trip.auto.not1","payload":{"trip_id":[35933]}}' , ['queue' => '1-queue-trip-erp','exchange' => '1-trip-events-erp', 'vhost' => 'havazerp']);
    return view('welcome');
    // echo phpinfo();
});
